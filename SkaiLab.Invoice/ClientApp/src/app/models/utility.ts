...
export class Utility {
    ...
    /* Helper function */
    static download_file(fileURL: string) {
        if (!fileURL.includes(".zip")) {
            $("#lnkOpenNewTabFile").attr("href", fileURL);
            document.getElementById('lnkOpenNewTabFile').click();
        }
        else {
            $("#lnkOpenFile").attr("href", fileURL);
            document.getElementById('lnkOpenFile').click();
        }
